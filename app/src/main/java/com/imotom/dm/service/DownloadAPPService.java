...
public class DownloadAPPService extends Service implements Consts {
...
//取消下载的网络请求
    ...
    private void downloadFile() {
        ...
        call = OkHttpUtils//
                ...
                .url(url)//
                .build();
        call.execute(new FileCallBack(Environment.getExternalStorageDirectory().getPath() + "/imotom", "zxc.com.gkdvr_21.apk")//
        {

            @Override
            public void onBefore(Request request, int id) {
                // tv_log.setText("开始下载固件");
                Log.d("MyService", "开始下载:"+ "zxc.com.gkdvr_21.apk");
            ...
            public void onError(Call call, Exception e, int id) {
                ...
                final File file = new File(Environment.getExternalStorageDirectory().getPath() + "/imotom", "zxc.com.gkdvr_21.apk");
                long ll = file.length();
                if (ll != wenJianDaXiao) {
                    file.delete();
                    Log.d("TAG", "__" + ll);
